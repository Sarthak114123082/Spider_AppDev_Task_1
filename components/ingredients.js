...
export default function List({navigation}) {
    ...
    const navigateToRecipe = () => {
        if ((selectedId1 && selectedId2 && selectedId3) || selectedId1 || selectedId2 || selectedId3 ) {
            navigation.navigate('Recipe'); 
        } 
        if ((selectedId1 && selectedId2 && selectedId3 && selectedId5 && selectedId4) || selectedId4 || selectedId5) {
            navigation.navigate('RecipeThreeFour'); 
        } 
        if ((selectedId1 && selectedId2 && selectedId3 && selectedId6 && selectedId7) || selectedId6 || selectedId7) {
            navigation.navigate('RecipeOneFour'); 
        }
        if ((selectedId1 && selectedId2 && selectedId3 &&  selectedId8) || selectedId8) {
            navigation.navigate('RecipeFive'); 
        }
        if ((selectedId1 && selectedId2 && selectedId3 &&  selectedId10) || selectedId10) {
